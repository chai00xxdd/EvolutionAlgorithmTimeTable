...
public class CommandLineTable   {
    ...
    private boolean seperateRows=false;

    public CommandLineTable() {
        setShowVerticalLines(true);
        setSeperateRows(true);
     
    }
   public void setSeperateRows(boolean seperateRows) {
	   this.seperateRows=seperateRows;
   }
    ...
    public void setHeaders(String... headers) {
        ...
        this.headersList = new ArrayList<>(Arrays.asList(headers));
        this.headers=new String[headersList.size()];
        this.headers=headersList.toArray(this.headers);
    }
    ...
    public void print() {
        ...
        for (String[] cells : rows) {
            ...
            if(seperateRows&&index++!=rows.size()-1)
              printLine(maxWidths);
